...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    private void createSpheres() {
	  ...
	  palmPositionSphere = createSphere("PalmPosition", PALM_RADIUS, !_showPalm);
	  wristPositionSphere = createSphere("WristPosition", SPHERE_RADIUS, !_showPalm);
